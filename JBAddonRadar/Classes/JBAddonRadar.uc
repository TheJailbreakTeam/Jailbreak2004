...
DefaultProperties
{
	...
	FriendlyName="Radar"
	Description="This addon adds a radar to the upper-right of your screen.||You can toggle its visibility with the key used to toggle the Onslaught radar (default is F12)."
	bIsOverlay=True
	bDrawRadar=True

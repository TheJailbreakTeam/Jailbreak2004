//=============================================================================
// JBMaterialTriggerReplicationInfo
// Copyright 2003 by Wormbo <wormbo@onlinehome.de>
// $Id$
//
// Used by JBMaterialTrigger to replicate material trigger events to
// network clients.
//=============================================================================


class JBMaterialTriggerReplicationInfo extends ReplicationInfo;
...
simulated function Timer()
{
  ...
  if ( MaterialToTrigger != None && TriggerCount > ClientTriggerCount
    ...
    if ( LastTriggerings[ClientTriggerCount % 10].TriggerAction == 2 )
      ...
      MaterialToTrigger.Trigger(LastTriggerings[ClientTriggerCount % 10].Triggerer, LastTriggerings[ClientTriggerCount % 10].EventInstigator);
  }
}
...
class JBMaterialTrigger extends MaterialTrigger;
...
var array<JBMaterialTriggerReplicationInfo> ReplicatedMaterialTriggers;


//=============================================================================
// PostBeginPlay
//
// Spawns a JBMaterialTriggerReplicationInfo for each triggered material.
//=============================================================================
...
function PostBeginPlay()
{
  ...
  for (i = 0; i < MaterialsToTrigger.Length; i++) {
    ReplicatedMaterialTriggers[i] = Spawn(class'JBMaterialTriggerReplicationInfo', Self);

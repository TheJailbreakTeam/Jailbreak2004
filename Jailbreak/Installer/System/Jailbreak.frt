...
QueueAnnouncements.Hint="Si vous voulez que les annonces Jailbreak s'effectuent l'une après l'autre. Dans le cas contraire plusieurs annonces pourraient se chevaucher."
OkButton.Caption="OK"
...
TextDescriptionFavorHumansForArena="Les humains sont préférés aux robots pour les combats d'arène."
...
TextDescriptionEnableJBMapFixes="Corrige de légers bugs dans certaines maps. Ajoute également une nouvelle exécution pour certaines."

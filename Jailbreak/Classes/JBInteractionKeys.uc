...
defaultproperties
{
  ...
  Dialog = (MaterialFrame=Texture'InterfaceContent.BorderBoxD',Margins=(X=30,Y=44),FontTitle="UT2SmallFont",FontText="UT2SmallFont",FontKey="UT2SmallFont",FontClose="UT2SmallFont",ColorTextTitle=(R=255,G=210,B=0),ColorText=(R=255,G=255,B=255),ColorTextKey=(R=255,G=210,B=0),ColorTextClose=(R=255,G=210,B=0),OffsetTextTitle=(Y=16),OffsetTextClose=(Y=-16));
